class Ctx < Formula
  ...
  on_macos do
    on_arm do
      url "https://ctx.ferrorium.com/dl/v0.1.0/ctx-aarch64-apple-darwin.tar.gz"
      sha256 "c0bccbd9e01f9ca3a8ca5d71f8ea7fdafefd58c8de300904c567b08760e5fa6a"
    end
    on_intel do
      url "https://ctx.ferrorium.com/dl/v0.1.0/ctx-x86_64-apple-darwin.tar.gz"
      sha256 "ecc96e852a412f0a985394c0d6ed7511dff65b6bcce57157f82430f57c441c9a"
    end
  end
  on_linux do
    on_arm do
      url "https://ctx.ferrorium.com/dl/v0.1.0/ctx-aarch64-unknown-linux-musl.tar.gz"
      sha256 "95dbbc063175689517906849c55d535663cda2918446ddfe09be86f9ba972277"
    end
    on_intel do
      url "https://ctx.ferrorium.com/dl/v0.1.0/ctx-x86_64-unknown-linux-musl.tar.gz"
